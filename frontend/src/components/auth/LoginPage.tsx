...
export function LoginPage({ onSwitchToRegister }: LoginPageProps) {
  const { login, error, clearError, isLoading, completeAuth } = useAuthStore();
      ...
      <div className="min-h-screen flex items-center justify-center bg-ax-bg-deep px-4">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="ax-glass rounded-2xl border border-white/[0.08] p-6 shadow-ax-modal text-center">
            ...
            <h2 className="ax-text-heading text-lg text-ax-text-primary mb-1">Bienvenido</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-ax-bg-deep px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="ax-glass rounded-2xl border border-white/[0.08] p-6 shadow-ax-modal">
          <h2 className="ax-text-heading text-lg text-ax-text-primary mb-1">Iniciar sesión</h2>
          <p className="text-xs text-ax-text-muted mb-6">Ingresa tus credenciales para acceder</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="login-email" className="block text-xs font-semibold text-ax-text-secondary mb-1.5">
                Correo electrónico
              </label>
              <input
                id="login-email"
            ...
            <div>
              <label htmlFor="login-password" className="block text-xs font-semibold text-ax-text-secondary mb-1.5">
                Contraseña
              </label>
              <input
                id="login-password"
