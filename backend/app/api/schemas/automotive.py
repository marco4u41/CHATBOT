...
class VehicleMarketStatsResponse(BaseModel):
    id: int
    manufacturer: str
    model: str
...
class ModelStatsResponse(BaseModel):
    success: bool = True
    data: VehicleMarketStatsResponse
...
class AutomotiveHealthResponse(BaseModel):
    success: bool
    database: str = "autoexpert_db"
    automotive_data_available: bool


class AutomotiveErrorResponse(BaseModel):
    success: bool = False
    error: str
